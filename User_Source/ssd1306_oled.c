...
void ssd1306_WriteCommand(uint8_t byte) {
    HAL_StatusTypeDef status = HAL_I2C_Mem_Write(&hi2c1, SSD1306_I2C_ADDR, 0x00, 1, &byte, 1, 100);
	//i2c1_write_mem(SSD1306_I2C_ADDR, 0x00,&byte, 1);
...
void ssd1306_WriteData(uint8_t* buffer, size_t buff_size) {
    HAL_StatusTypeDef status = HAL_I2C_Mem_Write(&hi2c1, SSD1306_I2C_ADDR, 0x40, 1, buffer, buff_size, 100);
      //i2c1_write_mem(SSD1306_I2C_ADDR, 0x40,buffer, buff_size);
		if (status != HAL_OK)
		{
//    I2C_Bus_Recovery();
		}
